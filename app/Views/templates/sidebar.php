...
<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="#" class="brand-link" style="text-align: center; font-weight: bold; padding: 4px">
        ...
        <span style="font-size: 26px; <?= ($session->get('tema') == 4) ? "color: #660F56" : "" ?>"><?= $session->get('xApp') ?></span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3">
            <img src="<?= base_url('assets/img/logomarcas') ?>/<?= ($session->get('logomarca') != "") ? $session->get('logomarca') : "logo-marca.png" ?>" style="width: 60px; margin: auto" alt="Logo Marca da Empresa">
            <span style="font-size: 16px; color: #660F56">
                <?= $session->get('xFant') ?>
            </span>
        </div>
