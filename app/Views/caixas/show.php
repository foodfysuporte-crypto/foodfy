                                ...
                                <div class="tab-pane fade" id="entradas" role="tabpanel" aria-labelledby="entradas-tab">
                                    <div class="table-responsive p-0">
                                        <table class="table table-hover text-nowrap table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th colspan="6" style="text-align: center">LANÇAMENTOS REGISTRADOS</th>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="table-responsive p-0">
                                        <table class="table table-hover text-nowrap table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><b>Total de Entradas:</b> <?= number_format(($valor_total_de_lancamentos), 2, ',', '.') ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Total de Saídas:</b> <?= number_format($valor_total_de_retiradas, 2, ',', '.') ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Saldo Final:</b> <?= number_format((($valor_total_de_lancamentos) - $valor_total_de_retiradas), 2, ',', '.') ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
