...
class Login extends Controller
{
    ...
    public function create()
    {
        ...
        $data['id_funcionario_pre_selecionado'] = $this->request->getGet('id_funcionario');
    ...
    public function store()
    {
        ...
        if(isset($dados['id_login'])):
            ...
            $this->login_model
                ...
                ->set('id_funcionario', (isset($dados['id_funcionario']) && $dados['id_funcionario'] != "") ? $dados['id_funcionario'] : null)
                ->update();
        ...
        $id_login = $this->login_model->insert([
            ...
            'senha'               => $senha,
            'tipo'                => 2, // 2=COMUM
            'esse_usuario_e_admin' => 0, // 0=NÃO
            'id_empresa'          => $this->id_empresa,
            'id_funcionario'      => (isset($dados['id_funcionario']) && $dados['id_funcionario'] != "") ? $dados['id_funcionario'] : null
        ]);
